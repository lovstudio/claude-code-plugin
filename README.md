<p align="center">
  <img src="docs/images/cover.png" alt="claude-plugins Cover" width="100%">
</p>
...
```bash
# Add marketplace
/plugin marketplace add lovstudio/claude-plugins

# Install plugin
/plugin install lovstudio@lovstudio-claude-plugins
```
